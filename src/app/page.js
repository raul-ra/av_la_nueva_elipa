...
export default function Home() {
  return (
    <div className="container mx-auto px-4">
      {/* Banner con h1 estilizado */}
      <h1 className="avallon-header text-center font-bold my-6">
        <span className="text-4xl md:text-5xl">Asociación Vecinal </span> 
        <span className="text-5xl md:text-7xl">La Nueva Elipa</span> <br />
        <span className="text-3xl md:text-5xl">Más de </span>
        <span className="text-5xl md:text-7xl text-red">40</span>
        <span className="text-3xl md:text-5xl"> años luchando por un barrio mejor</span>
      </h1>
